...
import WidgetLevelEditorPublishModalTextInput from "./WidgetLevelEditorPublishModalTextInput";

export default class WidgetLevelEditorPublishModal extends WidgetModal {

    private nameInput: WidgetLevelEditorPublishModalTextInput;
    private authorInput: WidgetLevelEditorPublishModalTextInput;
    private tagsInput: WidgetLevelEditorPublishModalTextInput;
    ...
    constructor() {
        ...
        this.nameInput = new WidgetLevelEditorPublishModalTextInput(this, "My Awesome Level");
        ...
        this.authorInput = new WidgetLevelEditorPublishModalTextInput(this, "An Awesome Human");
        ...
        this.tagsInput = new WidgetLevelEditorPublishModalTextInput(this, "");
