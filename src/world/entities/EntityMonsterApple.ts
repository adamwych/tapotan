...
export default class EntityMonsterApple extends EntityMonster {

    constructor(world: World) {
        super(world);

        this.entityType = EntityType.Apple;

        const idleSpritesheet = world.getTileset().getResourceByPath('Monsters/Apple/Idle').texture;
        const runSpritesheet = world.getTileset().getResourceByPath('Monsters/Apple/RunAnimation').texture;
        const runRightSpritesheet = world.getTileset().getResourceByPath('Monsters/Apple/RunRightAnimation').texture;
    ...
    public static fromSerialized(world: World, object: any) {
        const monster = new EntityMonsterApple(world);
