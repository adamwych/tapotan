...
export default class TileWaterBlock extends WorldObject {
    ...
    constructor(world: World) {
        ...
        if (!TileWaterBlock.sharedAnimatorTimer) {
        ...
        const idleSpritesheet = tileset.getResourceByPath('Environment/WaterBlock/Idle').texture;
        const animationSpritesheet = tileset.getResourceByPath('Environment/WaterBlock/Animation').texture;
        ...
        this.animator.addAnimation('animation', new PIXI.Sprite(animationSpritesheet), 11, 250);
    ...
    public static fromSerialized(world) {
        return new TileWaterBlock(world);
    }
