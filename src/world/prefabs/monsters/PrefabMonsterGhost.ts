...
export default createPrefabSpawnFunction('monsters_ghost', (gameObject: GameObject, world: World, props: PrefabBasicProps) => {
    populateBasicMonsterPrefab(gameObject, world, props, 0.66, 500, 500, monsterAnimatorTimer);
});