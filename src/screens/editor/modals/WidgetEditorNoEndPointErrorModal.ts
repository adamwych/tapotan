...
export default class WidgetEditorNoEndPointErrorModal extends WidgetModal {
    ...
    constructor() {
        ...
        let text = new WidgetText("You need to set the end point first.", WidgetText.Size.Medium, 0xee8d47);
